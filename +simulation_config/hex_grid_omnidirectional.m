classdef hex_grid_omnidirectional < utils.simulatorConfig
    methods (Static)
        function LTE_config = apply_parameters(LTE_config)
            ...
            switch LTE_config.network_source
                case 'generated'
                    ...
                    LTE_config.antenna_azimuth_offsett = 0;    % This controls the antenna layout that will be generated. 0 degrees generates hexagonal cells (3-sector case),
                    % while 30 degrees hexagonal sectors.
                    
                    LTE_config.sector_azimuths = 0;   % The actual azimuth will be antenna_azimuth_offsett+sector_azimuths, though. This parameter also specifies the number of sectors per site
            ...
            LTE_config.channel_model.type = 'winner+'; % 'winner+' 'PedB' 'extPedB' 'TU' 'Rayleigh' --> the PDP to use
            ...
            LTE_config.antenna.antenna_gain_pattern = 'omnidirectional';  % Additional parameters needed
            % LTE_config.antenna.antenna_gain_pattern = 'TS 36.942'; % As defined in TS 36.942. Identical to Berger, but with a 65° 3dB lobe
            
            LTE_config.antenna.max_antenna_gain = 17;

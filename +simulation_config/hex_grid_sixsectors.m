classdef hex_grid_sixsectors < utils.simulatorConfig
    methods (Static)
        function LTE_config = apply_parameters(LTE_config)
            ...
            switch LTE_config.network_source
                case 'generated'
                    ...
                    LTE_config.antenna_azimuth_offsett = 30;    % This controls the antenna layout that will be generated. 0 degrees generates hexagonal cells (3-sector case),
                    % while 30 degrees hexagonal sectors.
                    
                    LTE_config.sector_azimuths = 0:360/6:359;   % The actual azimuth will be antenna_azimuth_offsett+sector_azimuths, though. This parameter also specifies the number of sectors per site
            ...
            LTE_config.antenna.antenna_gain_pattern = 'six-sector';  % 35° antenna

classdef tri_sector < utils.simulatorConfig
    methods (Static)
        function LTE_config = apply_parameters(LTE_config)
            ...
            switch LTE_config.network_source
                case 'generated'
                    ...
                    LTE_config.sector_azimuths         = 0:360/3:359;
            ...
            LTE_config.antenna.antenna_gain_pattern = 'TS 36.942';  % Additional parameters needed

function [PMI] = Rel8_CLSM_PMI_layer_specific(H_t_precalculated,nLayers,W_all,nAtPort,receiver,wideband_precoder,N_0)
...
try
    ...
    I = feedback_calculation.codebook_capacity.sparse(H_t_precalculated,W_all_block,N_W,nLayers,receiver,N_0);
end

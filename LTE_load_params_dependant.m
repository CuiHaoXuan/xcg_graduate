...
LTE_config.default_channel_trace_folder = 'E:/matlab/lte_sim_1.8/LTE_System_level_1.8/data_files/channel_traces';
LTE_config.default_UE_cache_folder      = 'E:/matlab/lte_sim_1.8/LTE_System_level_1.8/data_files/UE_caches';
LTE_config.default_network_cache_folder = 'E:/matlab/lte_sim_1.8/LTE_System_level_1.8/data_files/network_caches';

%% Fill in some scheduler params

% Load the linear approximations to the BICM curves (necessary for scheduling)
load('E:/matlab/lte_sim_1.8/LTE_System_level_1.8/+utils/BICM_k_d_MSE.mat','k','d');
...
LTE_config.SNR_to_throughput_mapping = 'E:/matlab/lte_sim_1.8/LTE_System_level_1.8/data_files/SNR_to_throughput_mapping.mat';
...
if ~exist('E:/matlab/lte_sim_1.8/LTE_System_level_1.8/results','dir')%exist(LTE_config.results_folder,'dir')
    mkdir('E:/matlab/lte_sim_1.8/LTE_System_level_1.8/results');
end
...
switch LTE_config.channel_model.type
    case 'winner+'
        winner_model_path = 'E:/matlab/lte_sim_1.8/LTE_System_level_1.8/Winner Channel Model';
...
%% BLER curves
LTE_config.BLER_curves.folder = fullfile('E:','matlab','lte_sim_1.8','LTE_System_level_1.8','data_files','AWGN_BLERs');
...
LTE_config.SINR_averaging.BICM_capacity_tables = 'E:/matlab/lte_sim_1.8/LTE_System_level_1.8/data_files/BICM_capacity_tables_20000_realizations.mat';

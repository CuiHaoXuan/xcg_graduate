        ...
        function antenna_gain = gain(obj, phi, theta, electrical_tilt, mechanical_tilt)
            ...
            if index_
                ...
                if mechanical_tilt==0
                    ...
                    horizontal_gain = interp1(obj.horizontal_degree(:,index_), obj.horizontal_gain_pattern(:,index_), phi, 'pchip', 'extrap');
                    vertical_gain = interp1(obj.vertical_degree(:,index_), obj.vertical_gain_pattern(:,index_), theta,'pchip', 'extrap');
                ...
                % Mechanical tilting
                    ...
                    vert_gain_pattern = interp1(obj.vertical_degree(:,index_),  obj.vertical_gain_pattern(:,index_)  , utils.miscUtils.wrapTo359(A(:,:,2)) , 'pchip', 'extrap');
                    hor_gain_pattern  = interp1(obj.horizontal_degree(:,index_), obj.horizontal_gain_pattern(:,index_), A(:,:,3) , 'pchip', 'extrap');

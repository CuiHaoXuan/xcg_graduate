...
% (c) Josep Colom Ikuno, INTHFT, 2008
   ...
   methods
       ...
       % Version for the run-time precoding. Returns the channel matrix of the signal
       function H_0 = channel_matrix_signal(obj,t)
           % Index for the target and interfering channels
           index_position_mod = obj.get_index_positions(t,[]);
           H_0 = obj.ff_trace.H_0(:,:,:,:,index_position_mod);
       end
       
       % Version for the run-time precoding. Returns the channel matrix of the interferers
       function H_i = channel_matrix_interferers(obj,t,interfering_eNodeBs_idxs)
           % Index for the target and interfering channels
           [~,index_position_interf_mod] = obj.get_index_positions(t,interfering_eNodeBs_idxs);
           H_i = obj.ff_trace.H_i(:,:,:,:,index_position_interf_mod);
       end
